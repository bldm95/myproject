...
def player_detail(request, pk_team=1, pk_player=1):
    ...
    players = Player.objects.filter(team_id__exact=pk_team).exclude(pk__exact=pk_player)[:4] #возможно здесь можно и без фильтра по команде см получение игрока в team_detail
